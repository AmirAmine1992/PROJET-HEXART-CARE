...
void menu(){
    ...
    scanf("%d", &parametreAffichage); // On récupere la variable de l'utilisateur, c'est le choix du parametrage des LED
    ...
    switch (parametreAffichage){
        ...
        case 2:
            ...
            while (n < 0){
                ...
                scanf("%d", &n);
                if (n < 1 || n >= 10){ // Si l'utilisateur entre les mauvaises données
                    printf("\n Vous devez entrer une valeur comprise entre 2 et 10   !\n");
                    n = -1;// Pour que le programme reboucle cette partie.
                }
            }
        ...
        case 3:
            ...
            while (n < 0){
                ...
                if (n < 0 || n > 9){// Si l'utilisateur entre les mauvaises données
        ...
        case 4:
            ...
            while (n < 0){
                ...
                if (n < 1 || n > 3){ // Si l'utilisateur entre les mauvaises données
        ...
        default: //Si l'utilisateur entre une valeur autre que celles demandées
