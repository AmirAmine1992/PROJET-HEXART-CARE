...
void r_maxMin(Battements *b, int maxx ){
    //tri
    if (maxx == 2){
    printf("La plus grande fréquence cardiaque est à %dms et est de %dBPM", b[78].temps, b[78].bpm);
    }
    else if(maxx == 1){
     printf("La plus petite fréquence cardiaque est à %dms et est de %dBPM", b[0].temps, b[0].bpm);
    }
}
